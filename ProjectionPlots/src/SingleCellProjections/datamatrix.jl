...
var_coordinates(data::DataMatrix{<:LowRankFactorization}) = var_coordinates(data.matrix)
obs_coordinates(data::DataMatrix{<:LowRankFactorization}) = obs_coordinates(data.matrix)
